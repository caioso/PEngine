...
class RulesInterface
{
    ...
    public: virtual void Detect (LogicPanel *** _boardLogic, int boardW, int boardH, vector<Change> &changes) = 0;
    public: virtual void Fall (LogicPanel *** _boardLogic, int boardW, int boardH, vector<Change> &changes) = 0;
